...
export default class Login extends Component {
    constructor(props){
        super(props)
        this.state = { total_disposition:'',closing_inventory:'', opening_inventory:'', total_receipts:'',temperature:'', viscosity:'', well_id:''}
    ...
    handleSubmit(event){
        const { total_disposition, closing_inventory, opening_inventory, total_receipts, temperature, viscosity, well_id } = this.state
