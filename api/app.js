...
app.post('/register', async function (req, res) {
    ...
    let response = await helper.registerAndGetSecret(username, orgName, role);
...
app.post('/channels/:channelName/chaincodes/:chaincodeName', async function (req, res) {
    try {
        ...
        var funcInChaincode = req.body.function;
        ...
        let message = await invoke.invokeTransaction(channelName, chaincodeName, funcInChaincode, args, req.username, req.orgname);
...
*/
        ...
        let message = await query.query(channelName, chaincodeName, args, funcInChaincode, req.username, req.orgname);
