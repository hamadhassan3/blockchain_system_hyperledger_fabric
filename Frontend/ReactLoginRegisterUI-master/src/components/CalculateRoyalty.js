...
export default class CalculateRoyalty extends Component {
    
    constructor(props){
        super(props)
        this.state = { Date_and_Month:'',Test_Production:'', Test_Duration:'', Test_rate_per_hour:'',Hours_of_production:'', Estimated_Production:'', Production:''}
    ...
    handleSubmit(event){
        const { WTI, Value_of_C, Date_and_Month, Test_Production, Test_Duration, Test_rate_per_hour, Hours_of_production, Estimated_Production, Production } = this.state
        ...
        return (
			...
			onChange={this.handleChange} className="form-control"  />
                ...
                <div className="form-group">
                    ...
                    <input name='Value_of_C'
			placeholder='Value_of_C'
